 ...
 * 
 * Renamed to descriptors_impl_new.h by Dunwei Liu on 2021.
 */
...
#define TAGPTR1_OFFSET_STALE 0
#define TAGPTR1_OFFSET_TID 1 // old 1
#define TAGPTR1_MASK_STALE 0x1 // old 0x1
#define TAGPTR1_MASK_TID (((1<<OFFSET1_SEQ)-1)&(~(TAGPTR1_MASK_STALE)))
#define TAGPTR1_STALE(tagptr) (((tagptr_t) (tagptr)) & TAGPTR1_MASK_STALE)// old (((tagptr_t) (tagptr)) & TAGPTR1_MASK_STALE)
