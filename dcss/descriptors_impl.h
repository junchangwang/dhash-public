...
#define TAGPTR1_OFFSET_TID 3 // old 1
#define TAGPTR1_MASK_STALE 0x4 // old 0x1
#define TAGPTR1_MASK_TID (((1<<OFFSET1_SEQ)-1)&(~(TAGPTR1_MASK_STALE)))
#define TAGPTR1_STALE(tagptr) ((((tagptr_t) (tagptr)) & TAGPTR1_MASK_STALE)>>2) // old (((tagptr_t) (tagptr)) & TAGPTR1_MASK_STALE)
